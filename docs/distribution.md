...
```sh
cargo install --git https://github.com/nvk/chattybara.git --tag v0.1.0-alpha.10 --locked --package chattybara-cli --bin chattybara
```
...
- `dist/chattybara-0.1.0-alpha.10-aarch64-apple-darwin.tar.gz`
- `dist/chattybara-0.1.0-alpha.10-aarch64-apple-darwin.tar.gz.sha256`
